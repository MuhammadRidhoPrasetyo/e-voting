<x-layouts.app title="Tambah Pemilihan">
    @push('after-style')
        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Tambah Pemilihan</h3>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="datetime-local"
                                            class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active @error('start_time')
                                                is-invalid
                                            @enderror"
                                            name="start_time" placeholder="Y-m-d" value="{{ old('start_time') }}">
                                        @error('start_time')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="datetime-local"
                                            class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active @error('end_time')
                                                is-invalid
                                            @enderror"
                                            name="end_time" placeholder="Y-m-d" value="{{ old('end_time') }}">
                                        @error('end_time')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="space-x-2">
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                is-invalid
                                            @enderror"
                                                type="radio" id="status" name="status" value="active">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                is-invalid
                                            @enderror"
                                                type="radio" id="status" name="status" value="inactive">
